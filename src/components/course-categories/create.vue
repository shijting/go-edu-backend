    ...
    <div class="h-panel">
      ...
      <div class="h-panel-body">
       ...
       <Form  mode="block" ref="form" :validOnChange="true" :showErrorTip="true" :labelWidth="110" :rules="validRules" :model="courseCategories">
          <FormItem label="上级权限" prop="parent_id">
            <template v-slot:label>上级分类{{courseCategories.parent_id}}</template>
            <TreePicker :option="param" :useConfirm="useConfirm" :disabled="disabled" ref="treepicker" v-model="courseCategories.parent_id"></TreePicker>
